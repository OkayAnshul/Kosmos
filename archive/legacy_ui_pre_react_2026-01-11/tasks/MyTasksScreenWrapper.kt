...
import com.example.kosmos.shared.ui.components.ProjectPickerDialog
...
fun MyTasksScreenWrapper(
    ...
    MyTasksScreen(
        ...
        onRefresh = {
            ...
            coroutineScope.launch {
                ...
                viewModel.syncAllUserTasks()
                // loadAllUserTasks is already running via Flow, so no need to call again
    ...
    // Project Picker Dialog - Select project before creating task
    ...
    // Quick Task Creation Sheet - Create task in selected project
    if (showCreateTaskSheet && selectedProjectId != null) {
        QuickTaskCreationSheetWrapper(
            projectId = selectedProjectId!!,
            chatRoomId = null, // No chat room for cross-project tasks
            onDismiss = {
                showCreateTaskSheet = false
                selectedProjectId = null
            },
            onCreate = { taskId ->
                // Task created successfully - refresh the list
                viewModel.loadAllUserTasks()
            }
        )
    }
